  ...
  return (
    <>
      <PageHeader
        ...
        lede="Как изменится связность, если исключить клиентов из начала очереди проверки. Сценарий «что если» использует слабую связность без учёта направления переводов и не является рекомендацией к действию. Фрагмент — связная часть сети после исключения, а не кластер Louvain: кластеров больше, потому что Louvain делит на сообщества и связные части."
      />
